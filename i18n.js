...
window.I18N = {
  es: {
    ...
    chart_best_game: 'Mejor partida', chart_hover_score: 'Acumulado', chart_hover_accumulated: 'Puntaje acumulado', chart_hover_match: 'esta partida',
    ...
    yaku_title: 'Yakus Jugados', yakuman_title: 'Yakuman conseguidos', yakuman_empty: 'Aún no registra yakuman', achievements_title: 'Logros', achievements_hint: 'Distinciones especiales del jugador', achievement_profile: 'Récord destacado', achievement_profile_hint: 'Mejor estadística de la liga', achievement_saki: 'Medalla Saki', achievement_saki_hint: 'Puntaje más cercano a 0', achievement_empty_title: 'Este jugador aún no tiene logros', achievement_empty_hint: 'Sigue jugando para desbloquear su primera medalla.',
  ...
  en: {
    ...
    chart_best_game: 'Best game', chart_hover_score: 'Cumulative', chart_hover_accumulated: 'Cumulative score', chart_hover_match: 'this game',
    ...
    yaku_title: 'Yaku Played', yakuman_title: 'Yakuman achieved', yakuman_empty: 'No yakuman recorded yet', achievements_title: 'Achievements', achievements_hint: 'Special distinctions for this player', achievement_profile: 'Record holder', achievement_profile_hint: 'Best league statistic', achievement_saki: 'Saki medal', achievement_saki_hint: 'Score closest to 0', achievement_empty_title: 'This player has no achievements yet', achievement_empty_hint: 'Keep playing to unlock the first medal.',
  ...
  pt: {
    ...
    chart_best_game: 'Melhor partida', chart_hover_score: 'Acumulado', chart_hover_accumulated: 'Pontuação acumulada', chart_hover_match: 'esta partida',
    ...
    yaku_title: 'Yakus Jogados', yakuman_title: 'Yakuman conquistados', yakuman_empty: 'Ainda não registra yakuman', achievements_title: 'Conquistas', achievements_hint: 'Distinções especiais do jogador', achievement_profile: 'Recorde destacado', achievement_profile_hint: 'Melhor estatística da liga', achievement_saki: 'Medalha Saki', achievement_saki_hint: 'Pontuação mais próxima de 0', achievement_empty_title: 'Este jogador ainda não tem conquistas', achievement_empty_hint: 'Continue jogando para desbloquear a primeira medalha.',
