...
window.I18N = {
  es: {
    ...
    rules_advance: 'de 24 avanzan',
    rules_button: 'Ver reglas', rules_close: 'Cerrar reglas', rules_kicker: 'Reglamento', rules_title: 'Reglas de División {div}', rules_intro: 'Lo esencial para jugar, puntuar y coordinar cada sesión.', rules_hanchan: 'hanchan por sesión', rules_start: 'puntos iniciales', rules_sessions_title: 'Sesiones y ausencias', rules_sessions_1: 'Cada mesa agenda sus partidas dentro de la ventana de dos semanas.', rules_sessions_2: 'Cada sesión reúne dos hanchan Sur consecutivos el mismo día.', rules_sessions_3: 'Tras una primera advertencia, una segunda ausencia puede recibir −30 puntos y sustituto.', rules_score_title: 'Sistema de puntaje', rules_final_score: 'puntaje final', rules_score_example: 'Ejemplo División A: 1.º con 41.300 puntos obtiene 26,3 puntos de liga.', rules_playoffs_title: 'Clasificación a playoffs', rules_playoffs_text: 'Con 24 jugadores avanzan 12. El formato se ajusta al número de participantes.', rules_room_title: 'Sala Mahjong Soul · División {div}', rules_a_red: 'Sin akadora', rules_a_ron: 'Atamahane: un solo ron', rules_a_yakuman: 'Yakuman contado y múltiple; doble yakuman desactivado', rules_a_nagashi: 'Nagashi mangan desactivado', rules_a_kokushi: 'Kokushi no puede robar un kan cerrado', rules_b_red: '4 akadora', rules_b_ron: 'Múltiples ron activados', rules_b_yakuman: 'Yakuman contado, múltiple y doble activados', rules_b_nagashi: 'Nagashi mangan activado', rules_b_kokushi: 'Kokushi puede robar un kan cerrado', rules_common_title: 'Reglas comunes de sala', rules_common_1: 'Hanchan Este + Sur · tiempo 5 + 20 segundos', rules_common_2: 'Tanyao abierto y kiriage mangan activados', rules_common_3: 'Sin bancarrota ni yakus locales', rules_common_4: 'Riichi permitido en los últimos turnos; par de doble viento vale 2 fu', rules_eligibility_title: 'Elegibilidad internacional', rules_eligibility_text: 'La liga acepta cualquier nacionalidad. Para representar a Chile en IORMC/WRC se requiere nacionalidad chilena.', rules_stream_title: 'Transmisiones', rules_stream_text: 'La organización intentará transmitir todas las mesas posibles; una mesa sin transmisión juega igualmente.',
