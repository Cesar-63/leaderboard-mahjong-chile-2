...
window.I18N = {
  es: {
    ...
    yaku_story_label: 'Así gana este jugador', yaku_story_pressure_title: 'Presión y manos rápidas', yaku_story_pressure_text: '{first} marca su identidad; {second} acelera sus manos y {third} aparece junto a su presión temprana.', yaku_story_simple_title: 'Manos simples y eficientes', yaku_story_simple_text: '{first}, {second} y {third} forman un repertorio orientado a manos directas.', yaku_story_honors_title: 'Preferencia por los honores', yaku_story_honors_text: '{first}, {second} y {third} muestran una presencia marcada de vientos y dragones.', yaku_story_varied_title: 'Un repertorio variado', yaku_story_varied_text: '{first}, {second} y {third} son sus yakus más frecuentes, sin un único patrón dominante.', yaku_story_limited_text: '{first} es por ahora el yaku más registrado de este jugador.',
  ...
  en: {
    ...
    yaku_story_label: 'How this player wins', yaku_story_pressure_title: 'Pressure and quick hands', yaku_story_pressure_text: '{first} defines their identity; {second} speeds up their hands and {third} accompanies their early pressure.', yaku_story_simple_title: 'Simple, efficient hands', yaku_story_simple_text: '{first}, {second}, and {third} form a repertoire focused on direct hands.', yaku_story_honors_title: 'A preference for honors', yaku_story_honors_text: '{first}, {second}, and {third} show a strong presence of winds and dragons.', yaku_story_varied_title: 'A varied repertoire', yaku_story_varied_text: '{first}, {second}, and {third} are their most frequent yaku, without one dominant pattern.', yaku_story_limited_text: '{first} is currently this player’s most frequently recorded yaku.',
  ...
  pt: {
    ...
    yaku_story_label: 'Como este jogador vence', yaku_story_pressure_title: 'Pressão e mãos rápidas', yaku_story_pressure_text: '{first} define sua identidade; {second} acelera suas mãos e {third} acompanha sua pressão inicial.', yaku_story_simple_title: 'Mãos simples e eficientes', yaku_story_simple_text: '{first}, {second} e {third} formam um repertório voltado para mãos diretas.', yaku_story_honors_title: 'Preferência pelas honras', yaku_story_honors_text: '{first}, {second} e {third} mostram uma forte presença de ventos e dragões.', yaku_story_varied_title: 'Um repertório variado', yaku_story_varied_text: '{first}, {second} e {third} são seus yakus mais frequentes, sem um único padrão dominante.', yaku_story_limited_text: '{first} é, por enquanto, o yaku mais registrado deste jogador.',
